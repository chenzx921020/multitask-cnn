...
root_dir = "/data/zhixuan/multi_data/"
...
def fit(sym, train, val, batch_size, num_gpus):
    ...
    mod.fit(train, val,
            ...
            kvstore            ='device',
            optimizer          ='adam',
            optimizer_params   = {'learning_rate':0.001,'lr_scheduler': mx.lr_scheduler.FactorScheduler(step=10000,factor=0.6)},
...
if __name__ == "__main__":
    ...
    mod_score = fit(sym, train_iter, None, batch_size, num_gpus)
